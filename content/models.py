...
class HomePageContent(models.Model):
    ...
    menu_image = models.ImageField(
        upload_to="home_images/", verbose_name="Меню", blank=True, null=True
    )
    ...
    live_music_image = models.ImageField(
        upload_to="home_images/", verbose_name="Живая музыка", blank=True, null=True
    )
    ...
    scheme_image = models.ImageField(
        upload_to="home_images/", verbose_name="Схема проезда", blank=True, null=True
    )
...
class AboutContent(models.Model):
    ...
    history_image = models.ImageField(
        upload_to="home_images/", verbose_name="История", blank=True, null=True
    )
    ...
    mission_image = models.ImageField(
        upload_to="home_images/", verbose_name="Миссия", blank=True, null=True
    )
    ...
    band_image = models.ImageField(
        upload_to="home_images/", verbose_name="Команда", blank=True, null=True
    )
