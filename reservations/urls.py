...
urlpatterns = [
    path(
        "check-availability/",
        TableAvailabilityView.as_view(),
        name="check_availability",
    ),
    path("book/", TableBookingView.as_view(), name="table_booking"),
    path("success/", ReservationSuccessView.as_view(), name="reservation_success"),
